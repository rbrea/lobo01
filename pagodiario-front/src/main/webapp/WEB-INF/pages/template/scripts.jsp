<!-- Bootstrap core JavaScript
    ...
    <script src="${pageContext.request.contextPath}/public/js/app/Bill-3.js"></script>
    <script src="${pageContext.request.contextPath}/public/js/app/BillHistory-5.js"></script>
