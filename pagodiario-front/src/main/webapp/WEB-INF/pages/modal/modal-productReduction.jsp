  				...
  				<div class="panel-body">
					...
					<div class="form-group">
		            	...
		            	<div class='input-group date' id='productReductionDate'>
		                	<input type='text' class="form-control input-sm not-writable" id="productReductionDateValue" name="productReductionDateValue" placeholder="Ingrese fecha..." required/>
